...
import { AuthPalette, TaskerPalette, Typography } from '@/constants/theme';
...
export function CustomerProviderDetailsScreen() {
  const route = useRoute<any>();
  const navigation = useNavigation<NativeStackNavigationProp<CustomerTabParamList>>();
  const providerId = route.params?.providerId;
  const [activeTab, setActiveTab] = useState('About Me');

  const { data: profile, isLoading, isError, refetch } = useProviderDetails(providerId);
    ...
    return (
      <View style={[styles.root, { justifyContent: 'center', alignItems: 'center' }]}>
        ...
        <Pressable onPress={() => refetch()} style={{ marginTop: 20 }}>
          <Text style={{ color: ACCENT_BLUE, fontWeight: 'bold' }}>Retry</Text>
        </Pressable>
  ...
  const getFullImageUrl = (url: string | null | undefined) => {
    ...
    return res || 'https://i.pravatar.cc/300?u=john';
  };
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.profileHeader}>
          ...
          <View style={styles.statsRow}>
            ...
            <View style={styles.rateContainer}>
              ...
              <Text style={styles.rateValue}>£{profile.price_hourly || 0}/hr</Text>
            </View>
          </View>
        </View>
          ...
          <View style={styles.content}>
            ...
            <View style={styles.section}>
              ...
              {profile.certificates?.length > 0 ? (
                ...
                <Text style={styles.descriptionText}>No certifications available.</Text>
              )}
            </View>
          </View>
        )}
          ...
          <View style={styles.content}>
            <View style={styles.section}>
              ...
              <View style={styles.offersRow}>
                ...
                {(!profile.subcategories || profile.subcategories.filter((s: any) => s.isSelected).length === 0) && (
                  <Text style={styles.descriptionText}>No services listed.</Text>
                )}
              </View>
            </View>
            ...
            <View style={styles.section}>
              ...
              {profile.subcategories?.filter((s: any) => s.isSelected).length > 0 ? (
                ...
                <Text style={styles.descriptionText}>No skills listed.</Text>
              )}
            </View>
          </View>
        )}
          ...
          <View style={styles.content}>
            <View style={styles.portfolioGrid}>
              {profile.portfolio?.length > 0 ? (
                ...
                <Text style={styles.descriptionText}>No portfolio images available.</Text>
              )}
            </View>
          </View>
        )}
        ...
        <View style={styles.footer}>
          <Pressable
            ...
            onPress={() => {
              navigation.navigate('CustomerHireProfessional', { providerId });
            }}
          >
