      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.switchCard}>
          <View style={styles.switchTop}>
            ...
            <View>
              <Text style={styles.switchTitle}>Switch to Tasker Mode</Text>
              <Text style={styles.switchSubtitle}>Start earning today</Text>
            </View>
          </View>
          <Pressable
            ...
            onPress={() => {
              Alert.alert('Switch to Tasker', 'Switch your account to Tasker mode?', [
            ...
            <View style={styles.switchBtnLeft}>
              ...
              <Text style={styles.switchBtnText}>Become a Tasker</Text>
            </View>
        ...
        <View style={styles.menuContainer}>
          ...
          <MenuItem
            icon="star"
            label="My Reviews"
            onPress={() => navigation.navigate('CustomerReviews')}
          />
          <MenuItem icon="gift" label="Refer a Friend" onPress={() => navigation.navigate('CustomerReferral')} />
          <MenuItem
            icon="file-text"
            label="Terms of use"
            onPress={() =>
          ...
          <MenuItem
            icon="list"
            label="FAQ"
            onPress={() => navigation.navigate('LegalWebView', { title: 'FAQ', uri: nativeEnv.faqUrl })}
          />
          <MenuItem
            icon="help-circle"
            label="Help & Support"
  ...
  return (
    <Pressable style={[styles.menuItem, isLast && styles.noBorder]} onPress={onPress}>
      <View style={styles.menuIconWrap}>
        <Svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={NAVY} strokeWidth="1.8">
          {icon === 'user' && (
            <>
              <Path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2" />
              <Circle cx="12" cy="7" r="4" />
          ...
          {icon === 'history' && <Path d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />}
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    paddingBottom: 0, // Reset padding as card is absolute
    zIndex: 10,
  },
  headerTopRow: {
    flexDirection: 'row',
  ...
  scroll: {
    paddingHorizontal: 20,
    paddingTop: 80, // Space for the overlapping user card
    paddingBottom: 40,
  },
  userCard: {
    ...
    alignItems: 'center',
    position: 'absolute',
    bottom: -60, // Positioned at the bottom of the header with overlap
    left: 20,
    right: 20,
    shadowColor: '#000',
